...
puts 'Please enter a name for your dragon'
new_name = gets.chomp
pet = Dragon.new new_name

command = ''

while command != 'exit'
puts 'Enter one of the following commands to control your dragon:'
puts 'feed, walk, put_to_bed, toss, rock'
puts 'or enter "exit" to exit program'
command = gets.chomp
if command == 'feed'
pet.feed
elsif command == 'walk'
